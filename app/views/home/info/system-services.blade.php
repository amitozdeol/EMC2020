<div class="col-xs-12 col-lg-10 col-lg-offset-1 tallest-height">
	<a href="{{URL::to('emc2020')}}">
		<div class="col-xs-12 col-md-6 taller-height transparent_blue_white border_blue_white" style="color: black; text-align: center;">
			...
			<br>
			<h3> Requiring minimal down-time, so you can be back online faster!</h3>
			<br>
	...
	<a href="{{URL::to('emc-zigbee-wireless')}}">
		<div class="col-xs-12 col-md-6 taller-height transparent_blue_white border_blue_white" style="color: black; text-align: center;">
			...
			<br>
			<h3>Sharpen your vision with a fleet of our wireless sensors.</h3>
			<br>
			<h2>ALL YOUR SENSORS</h2>
		</div>
	</a>
	<div class="col-xs-12 col-md-12 taller-height transparent_blue_white border_blue_white" style="">
		<h2>
			Monitoring
		</h2>
		<p>
