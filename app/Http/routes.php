  ...
  Route::group(['before' => 'building_manager'], function($route){
    ...
    */
    Route::group(['before' => 'auth_admin'], function($route){
      ...
      Route::resource('building/{id}/editsystem/{sid}/algorithm', 'AlgorithmController',
        ['names' => [
      ...
      Route::resource('building/{id}/editsystem/{sid}/webmapping', 'WebMappingController',
        ['names' => [
    ...
    Route::resource('building/{id}/editsystem/{sid}/zone', 'ZoneController',
      ['names' => [
        'index'   => 'zone.index',
        'create'  => 'zone.create',
        'store'   => 'zone.store',
    ...
    Route::resource('building/{id}/editsystem/{sid}/chart', 'ChartController',
      ['names' => [
        'edit'    => 'charts.edit',
    ...
    Route::group(['before' => 'auth_setpointmapping'], function($route){
      Route::resource('building/{id}/editsystem/{sid}/setpointmapping', 'SetpointMappingController',
         ['names' => [
