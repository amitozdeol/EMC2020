! function(t, e) {
    ...
    function t(t, e) {
        ...
        function s() {
            var t, i = _.copy();
            return e.isCategory && (t = _.domain(), i.domain([t[0], t[1] - 1])), i
        }
        ...
        function d(t) {
            ...
            return t.select("text").text(c).each(function(t) {
                var i = this.getBoundingClientRect(),
                    n = c(t),
                    a = i.height,
                    r = n ? i.width / n.length : void 0;
                a && r && (e.h = a, e.w = r)
            }).text(""), r = e, e
        }
        ...
        function u(r) {
            r.each(function() {
                function r(t, i) {
                    function n(t, e) {
                        ...
                        for (var s = 1; s < e.length; s++)
                            if (" " === e.charAt(s) && (r = s), a = e.substr(0, s + 1), o = z.w * a.length, i < o) return n(t.concat(e.substr(0, r || s)), e.slice(r ? r + 1 : s));
                        return t.concat(e)
                    }
                    var a, r, o, s = c(t),
                        d = [];
                    return "[object Array]" === Object.prototype.toString.call(s) ? s : ((!i || i <= 0) && (i = Y ? 95 : e.isCategory ? Math.ceil(P(L[1]) - P(L[0])) - 12 : 110), n(d, s + ""))
                }

                function g(t, e) {
                    var i = z.h;
                    return 0 === e && (i = "left" === x || "right" === x ? -((B[t.index] - 1) * (z.h / 2) - 3) : ".71em"), i
                }
                var p, v, b, A = u.g = t.select(this),
                    T = this.__chart__ || _,
                    P = this.__chart__ = s(),
                    L = S || o(P),
                    C = A.selectAll(".tick").data(L, P),
                    V = C.enter().insert("g", ".domain").attr("class", "tick").style("opacity", 1e-6),
                    G = C.exit().remove(),
                    E = l(C).style("opacity", 1),
                    I = _.rangeExtent ? _.rangeExtent() : a(_.range()),
                    O = A.selectAll(".domain").data([0]),
                    R = (O.enter().append("path").attr("class", "domain"), l(O));
                V.append("line"), V.append("text");
                var D = V.select("line"),
                    F = E.select("line"),
                    X = V.select("text"),
                    k = E.select("text");
                e.isCategory ? (w = Math.ceil((P(1) - P(0)) / 2), v = f ? 0 : w, b = f ? w : 0) : w = v = 0;
                var M, H, z = d(A.select(".tick")),
                    B = [],
                    N = Math.max(y, 0) + m,
                    Y = "left" === x || "right" === x;
                (H = (M = C.select("text")).selectAll("tspan").data(function(t, i) {
                    var n = e.tickMultiline ? r(t, e.tickWidth) : [].concat(c(t));
                    return B[i] = n.length, n.map(function(t) {
                        return {
                            index: i,
                            splitted: t
                        }
                    })
                })).enter().append("tspan"), H.exit().remove(), H.text(function(t) {
                    return t.splitted
                });
                var j = e.tickTextRotate;
                switch (x) {
                    case "bottom":
                        p = i, D.attr("y2", y), X.attr("y", N), F.attr("x1", v).attr("x2", v).attr("y2", function(t) {
                            var e = _(t) + (f ? 0 : w);
                            return I[0] < e && e < I[1] ? y : 0
                        }), k.attr("x", 0).attr("y", function(t) {
                            return t ? 11.5 - t / 15 * 2.5 * (t > 0 ? 1 : -1) : N
                        }(j)).style("text-anchor", function(t) {
                            return t ? t > 0 ? "start" : "end" : "middle"
                        }(j)).attr("transform", function(t) {
                            return t ? "rotate(" + t + ")" : ""
                        }(j)), H.attr("x", 0).attr("dy", g).attr("dx", function(t) {
                            return t ? 8 * Math.sin(Math.PI * (t / 180)) : 0
                        }(j)), R.attr("d", "M" + I[0] + "," + h + "V0H" + I[1] + "V" + h);
                        break;
                    case "top":
                        p = i, D.attr("y2", -y), X.attr("y", -N), F.attr("x2", 0).attr("y2", -y), k.attr("x", 0).attr("y", -N), M.style("text-anchor", "middle"), H.attr("x", 0).attr("dy", "0em"), R.attr("d", "M" + I[0] + "," + -h + "V0H" + I[1] + "V" + -h);
                        break;
                    case "left":
                        p = n, D.attr("x2", -y), X.attr("x", -N), F.attr("x2", -y).attr("y1", b).attr("y2", b), k.attr("x", -N).attr("y", w), M.style("text-anchor", "end"), H.attr("x", -N).attr("dy", g), R.attr("d", "M" + -h + "," + I[0] + "H0V" + I[1] + "H" + -h);
                        break;
                    case "right":
                        p = n, D.attr("x2", y), X.attr("x", N), F.attr("x2", y).attr("y2", 0), k.attr("x", N).attr("y", 0), M.style("text-anchor", "start"), H.attr("x", N).attr("dy", g), R.attr("d", "M" + h + "," + I[0] + "H0V" + I[1] + "H" + h)
                }
                if (P.rangeBand) {
                    var U = P,
                        W = U.rangeBand() / 2;
                ...
                } else T.rangeBand ? T = P : G.call(p, P);
                V.call(p, T), E.call(p, P)
            })
        }
        var h, g, p, f, _ = t.scale.linear(),
            x = "bottom",
            y = 6,
            m = 3,
            S = null,
            w = 0,
            v = !0;
        return e = e || {}, h = e.withOuterTick ? 6 : 0, u.scale = function(t) {
            return arguments.length ? (_ = t, u) : _
        }, u.orient = function(t) {
            return arguments.length ? (x = t in {
                top: 1,
                right: 1,
                bottom: 1,
                left: 1
        ...
        }, u.tickCentered = function(t) {
            return arguments.length ? (f = t, u) : f
        }, u.tickOffset = function() {
            return w
        }, u.tickInterval = function() {
            var t;
            return t = e.isCategory ? 2 * w : (u.g.select("path.domain").node().getTotalLength() - 2 * h) / u.g.selectAll("line").size(), t === 1 / 0 ? 0 : t
        }, u.ticks = function() {
            return arguments.length ? (p = arguments, u) : p
        }, u.tickCulling = function(t) {
            return arguments.length ? (v = t, u) : v
        }, u.tickValues = function(t) {
            if ("function" == typeof t) S = function() {
                return t(_.domain())
            };
            else {
    ...
    function n(t) {
        var e = this.internal = new a(this);
    ...
    var r, o = {
        ...
        _ = function(t) {
            return void 0 === t || null === t || l(t) && 0 === t.length || "object" == typeof t && 0 === Object.keys(t).length
        },
        x = function(t) {
            return !b.isEmpty(t)
        },
    ...
    ! function(t, e) {
        ...
        var c = this.owner,
            ...
            l = {
                ...
                tickTextRotate: s ? 0 : d.axis_x_tick_rotate,
                withoutTransition: o
            },
            u = t(c.d3, l).scale(e).orient(i);
        return c.isTimeSeries() && a && "function" != typeof a && (a = a.map(function(t) {
            return c.parseDate(t)
        })), u.tickFormat(n).tickValues(a), c.isCategorized() && (u.tickCentered(d.axis_x_tick_centered), _(d.axis_x_tick_culling) && (d.axis_x_tick_culling = !1)), u
    ...
    }, e.prototype.getYAxis = function(e, i, n, a, r, o, s) {
        var c = this.owner,
            d = c.config,
            l = {
                withOuterTick: r,
                withoutTransition: o,
                tickTextRotate: s ? 0 : d.axis_y_tick_rotate
            },
            u = t(c.d3, l).scale(e).orient(i).tickFormat(n);
        return c.isTimeSeriesY() ? u.ticks(c.d3.time[d.axis_y_tick_time_value], d.axis_y_tick_time_interval) : u.tickValues(a), u
        ...
        return l(e) ? e : e ? e.text : null
    }, e.prototype.setLabelText = function(t, e) {
        var i = this.owner.config,
            n = this.getLabelOptionByAxisId(t);
        l(n) ? "y" === t ? i.axis_y_label = e : "y2" === t ? i.axis_y2_label = e : "x" === t && (i.axis_x_label = e) : n && (n.text = e)
        ...
        var e = this.owner,
            i = e.main.select("." + o.axisX + " ." + o.axisXLabel),
            n = e.main.select("." + o.axisY + " ." + o.axisYLabel),
            a = e.main.select("." + o.axisY2 + " ." + o.axisY2Label);
    ...
    }, e.prototype.getPadding = function(t, e, i, n) {
    ...
    }, e.prototype.generateTickValues = function(t, e, i) {
        var n, a, r, o, s, d, l, u = t;
        if (e)
            if (1 === (n = c(e) ? e() : e)) u = [t[0]];
            else if (2 === n) u = [t[0], t[t.length - 1]];
        else if (n > 2) {
            for (o = n - 2, a = t[0], s = ((r = t[t.length - 1]) - a) / (o + 1), u = [a], d = 0; d < o; d++) l = +a + s * (d + 1), u.push(i ? new Date(l) : l);
            u.push(r)
        }
    ...
    return A.generate = function(t) {
    ...
    }, v = A.chart.fn, b = A.chart.internal.fn, A.chart.internal.axis.fn, b.beforeInit = function() {}, b.afterInit = function() {}, b.init = function() {
        var t = this,
            e = t.config;
        ...
        _ = O.generateDrawArea ? O.generateDrawArea(X, !1) : void 0, x = O.generateDrawBar ? O.generateDrawBar(k) : void 0, m = O.generateDrawLine ? O.generateDrawLine(M, !1) : void 0, S = O.generateXYForText(X, k, M, !0), w = O.generateXYForText(X, k, M, !1), i && (O.subY.domain(O.getYDomain(z, "y")), O.subY2.domain(O.getYDomain(z, "y2"))), O.updateXgridFocus(), R.select("text." + o.text + "." + o.empty).attr("x", O.width / 2).attr("y", O.height / 2).text(F.data_empty_label_text).transition().style("opacity", z.length ? 0 : 1), O.updateGrid(v), O.updateRegion(v), O.updateBar(b), O.updateLine(b), O.updateArea(b), O.updateCircle(), O.hasDataLabel() && O.updateText(b), O.redrawTitle && O.redrawTitle(), O.redrawArc && O.redrawArc(v, b, c), O.redrawSubchart && O.redrawSubchart(n, e, v, b, X, k, M), R.selectAll("." + o.selectedCircles).filter(O.isBarType.bind(O)).selectAll("circle").remove(), F.interaction_enabled && !t.flow && g && (O.redrawEventRect(), O.updateZoom && O.updateZoom()), O.updateCircleY(), E = (O.config.axis_rotated ? O.circleY : O.circleX).bind(O), I = (O.config.axis_rotated ? O.circleX : O.circleY).bind(O), t.flow && (P = O.generateFlow({
            ...
            xForText: S,
            yForText: w
        })), (v || P) && O.isTabVisible() ? D.transition().duration(v).each(function() {
            var e = [];
            [O.redrawBar(x, !0), O.redrawLine(m, !0), O.redrawArea(_, !0), O.redrawCircle(E, I, !0), O.redrawText(S, w, t.flow, !0), O.redrawRegion(!0), O.redrawGrid(!0)].forEach(function(t) {
                t.forEach(function(t) {
                    e.push(t)
                })
            }), T = O.generateWait(), e.forEach(function(t) {
                T.add(t)
            })
        }).call(T, function() {
            P && P(), F.onrendered && F.onrendered.call(O)
        }) : (O.redrawBar(x), O.redrawLine(m), O.redrawArea(_), O.redrawCircle(E, I), O.redrawText(S, w, t.flow), O.redrawRegion(), O.redrawGrid(), F.onrendered && F.onrendered.call(O)), O.mapToIds(O.data.targets).forEach(function(t) {
            O.withoutFadeIn[t] = !0
        })
    }, b.updateAndRedraw = function(t) {
        var e, i = this,
            n = i.config;
    ...
    }, b.getTranslate = function(t) {
        var e, i, n = this,
            a = n.config;
        return "main" === t ? (e = p(n.margin.left), i = p(n.margin.top)) : "context" === t ? (e = p(n.margin2.left), i = p(n.margin2.top)) : "legend" === t ? (e = n.margin3.left, i = n.margin3.top) : "x" === t ? (e = 0, i = a.axis_rotated ? 0 : n.height) : "y" === t ? (e = 0, i = a.axis_rotated ? n.height : 0) : "y2" === t ? (e = a.axis_rotated ? 0 : n.width, i = a.axis_rotated ? 1 : 0) : "subx" === t ? (e = 0, i = a.axis_rotated ? 0 : n.height2) : "arc" === t && (e = n.arcWidth / 2, i = n.arcHeight / 2), "translate(" + e + "," + i + ")"
    }, b.initialOpacity = function(t) {
        return null !== t.value && this.withoutFadeIn[t.id] ? 1 : 0
    }, b.initialOpacityForCircle = function(t) {
        return null !== t.value && this.withoutFadeIn[t.id] ? this.opacityForCircle(t) : 0
    }, b.opacityForCircle = function(t) {
    ...
    }, b.transformMain = function(t, e) {
        var i, n, a, r = this;
        e && e.axisX ? i = e.axisX : (i = r.main.select("." + o.axisX), t && (i = i.transition())), e && e.axisY ? n = e.axisY : (n = r.main.select("." + o.axisY), t && (n = n.transition())), e && e.axisY2 ? a = e.axisY2 : (a = r.main.select("." + o.axisY2), t && (a = a.transition())), (t ? r.main.transition() : r.main).attr("transform", r.getTranslate("main")), i.attr("transform", r.getTranslate("x")), n.attr("transform", r.getTranslate("y")), a.attr("transform", r.getTranslate("y2")), r.main.select("." + o.chartArcs).attr("transform", r.getTranslate("arc"))
    }, b.transformAll = function(t, e) {
        var i = this;
    ...
    }, b.parseDate = function(t) {
        var e, i = this;
        return t instanceof Date ? e = t : "string" == typeof t ? e = i.dataTimeFormat(i.config.data_xFormat).parse(t) : "object" == typeof t ? e = new Date(+t) : "number" != typeof t || isNaN(t) || (e = new Date(+t)), e && !isNaN(+e) || window.console.error("Failed to parse x '" + t + "' to Date object"), e
    ...
    }, b.isValue = s, b.isFunction = c, b.isString = l, b.isUndefined = u, b.isDefined = h, b.ceil10 = g, b.asHalfPixel = p, b.diffDomain = f, b.isEmpty = _, b.notEmpty = x, b.notEmpty = x, b.getOption = y, b.hasValue = m, b.sanitise = S, b.getPathBox = w, b.CLASS = o, Function.prototype.bind || (Function.prototype.bind = function(t) {
        ...
        "object" == typeof t ? (s(t.x) && (i.axis_x_max = t.x), s(t.y) && (i.axis_y_max = t.y), s(t.y2) && (i.axis_y2_max = t.y2)) : i.axis_y_max = i.axis_y2_max = t, e.redraw({
            withUpdateOrgXDomain: !0,
            withUpdateXDomain: !0
        })
    }, v.axis.min = function(t) {
        var e = this.internal,
            i = e.config;
        if (!arguments.length) return {
            x: i.axis_x_min,
        ...
        "object" == typeof t ? (s(t.x) && (i.axis_x_min = t.x), s(t.y) && (i.axis_y_min = t.y), s(t.y2) && (i.axis_y2_min = t.y2)) : i.axis_y_min = i.axis_y2_min = t, e.redraw({
            withUpdateOrgXDomain: !0,
            withUpdateXDomain: !0
        })
    }, v.axis.range = function(t) {
        if (!arguments.length) return {
            max: this.axis.max(),
            min: this.axis.min()
        };
        void 0 !== t.max && this.axis.max(t.max), void 0 !== t.min && this.axis.min(t.min)
    }, v.category = function(t, e) {
        var i = this.internal,
            n = i.config;
        return arguments.length > 1 && (n.axis_x_categories[t] = e, i.redraw()), n.axis_x_categories[t]
    }, v.categories = function(t) {
        var e = this.internal,
            i = e.config;
        ...
        e = d.convertDataToTargets(i, !0), d.data.targets.forEach(function(t) {
            ...
            for (i = 0; i < e.length; i++)
                if (t.id === e[i].id) {
                    for (a = !0, t.values[t.values.length - 1] && (g = t.values[t.values.length - 1].index + 1), h = e[i].values.length, n = 0; n < h; n++) e[i].values[n].index = g + n, d.isTimeSeries() || (e[i].values[n].x = g + n);
            ...
            for (e = 0; e < l.length; e++)
                if (t.id === l[e])
                    for (g = t.values[t.values.length - 1].index + 1, i = 0; i < h; i++) t.values.push({
                        id: t.id,
                        index: g + i,
                        x: d.isTimeSeries() ? d.getOtherTargetX(g + i) : g + i,
                        value: null
                    })
        }), d.data.targets.length && e.forEach(function(t) {
            var e, i = [];
            for (e = d.data.targets[0].values[0].index; e < g; e++) i.push({
                id: t.id,
                index: e,
            ...
            t.values.forEach(function(t) {
                t.index += g, d.isTimeSeries() || (t.x += g)
            }), t.values = i.concat(t.values)
        }), d.data.targets = d.data.targets.concat(e), d.getMaxDataCount(), r = (a = d.data.targets[0]).values[0], void 0 !== t.to ? (h = 0, c = d.isTimeSeries() ? d.parseDate(t.to) : t.to, a.values.forEach(function(t) {
            t.x < c && h++
        })) : void 0 !== t.length && (h = t.length), u ? 1 === u && d.isTimeSeries() && (o = (a.values[a.values.length - 1].x - r.x) / 2, n = [new Date(+r.x - o), new Date(+r.x + o)], d.updateXDomain(null, !0, !0, !1, n)) : (o = d.isTimeSeries() ? a.values.length > 1 ? a.values[a.values.length - 1].x - r.x : r.x - d.getXDomain(d.data.targets)[0] : 1, n = [r.x - o, r.x], d.updateXDomain(null, !0, !0, !1, n)), d.updateTargets(d.data.targets), d.redraw({
            flow: {
                index: r.index,
                length: h,
    ...
    }, b.generateFlow = function(t) {
        var e = this,
            i = e.config,
            n = e.d3;
        return function() {
            var a, r, s, c = t.targets,
                d = t.flow,
                l = t.drawBar,
                u = t.drawLine,
                h = t.drawArea,
                ...
                I = e.mainText || n.selectAll([]),
                O = e.mainBar || n.selectAll([]),
                R = e.mainLine || n.selectAll([]),
                D = e.mainArea || n.selectAll([]),
                F = e.mainCircle || n.selectAll([]);
            e.flowing = !0, e.data.targets.forEach(function(t) {
                t.values.splice(0, v)
            }), s = e.updateXDomain(c, !0, !0), e.updateXGrid && e.updateXGrid(!0), d.orgDataCount ? a = 1 === d.orgDataCount || (b && b.x) === (A && A.x) ? e.x(T[0]) - e.x(s[0]) : e.isTimeSeries() ? e.x(T[0]) - e.x(s[0]) : e.x(b.x) - e.x(A.x) : 1 !== e.data.targets[0].values.length ? a = e.x(T[0]) - e.x(s[0]) : e.isTimeSeries() ? (b = e.getValueOnIndex(e.data.targets[0].values, 0), A = e.getValueOnIndex(e.data.targets[0].values, e.data.targets[0].values.length - 1), a = e.x(b.x) - e.x(A.x)) : a = f(s) / 2, S = f(T) / f(s), r = "translate(" + a + ",0) scale(" + S + ",1)", e.hideXGridFocus(), n.transition().ease("linear").duration(P).each(function() {
                C.add(e.axes.x.transition().call(e.xAxis)), C.add(O.transition().attr("transform", r)), C.add(R.transition().attr("transform", r)), C.add(D.transition().attr("transform", r)), C.add(F.transition().attr("transform", r)), C.add(I.transition().attr("transform", r)), C.add(E.filter(e.isRegionOnX).transition().attr("transform", r)), C.add(V.transition().attr("transform", r)), C.add(G.transition().attr("transform", r))
            }).call(C, function() {
                var t, n = [],
                    a = [],
                    r = [];
                if (v) {
                    for (t = 0; t < v; t++) n.push("." + o.shape + "-" + (w + t)), a.push("." + o.text + "-" + (w + t)), r.push("." + o.eventRect + "-" + (w + t));
                    e.svg.selectAll("." + o.shapes).selectAll(n).remove(), e.svg.selectAll("." + o.texts).selectAll(a).remove(), e.svg.selectAll("." + o.eventRects).selectAll(r).remove(), e.svg.select("." + o.xgrid).remove()
                }
                V.attr("transform", null).attr(e.xgridAttr), G.attr("transform", null), G.select("line").attr("x1", i.axis_rotated ? 0 : _).attr("x2", i.axis_rotated ? e.width : _), G.select("text").attr("x", i.axis_rotated ? e.width : 0).attr("y", _), O.attr("transform", null).attr("d", l), R.attr("transform", null).attr("d", u), D.attr("transform", null).attr("d", h), F.attr("transform", null).attr("cx", g).attr("cy", p), I.attr("transform", null).attr("x", x).attr("y", y).style("fill-opacity", e.opacityForText.bind(e)), E.attr("transform", null), E.select("rect").filter(e.isRegionOnX).attr("x", e.regionX.bind(e)).attr("width", e.regionWidth.bind(e)), i.interaction_enabled && e.redrawEventRect(), L(), e.flowing = !1
            })
        }
    }, v.focus = function(t) {
        var e, i = this.internal;
        t = i.mapToTargetIds(t), e = i.svg.selectAll(i.selectorTargets(t.filter(i.isTargetToShow, i))), this.revert(), this.defocus(), e.classed(o.focused, !0).classed(o.defocused, !1), i.hasArcType() && i.expandArc(t), i.toggleFocusLegend(t, !0), i.focusedTargetIds = t, i.defocusedTargetIds = i.defocusedTargetIds.filter(function(e) {
            return t.indexOf(e) < 0
        })
    }, v.defocus = function(t) {
        var e = this.internal;
        t = e.mapToTargetIds(t), e.svg.selectAll(e.selectorTargets(t.filter(e.isTargetToShow, e))).classed(o.focused, !1).classed(o.defocused, !0), e.hasArcType() && e.unexpandArc(t), e.toggleFocusLegend(t, !1), e.focusedTargetIds = e.focusedTargetIds.filter(function(e) {
            return t.indexOf(e) < 0
        }), e.defocusedTargetIds = t
    }, v.revert = function(t) {
        var e = this.internal;
        t = e.mapToTargetIds(t), e.svg.selectAll(e.selectorTargets(t)).classed(o.focused, !1).classed(o.defocused, !1), e.hasArcType() && e.unexpandArc(t), e.config.legend_show && (e.showLegend(t.filter(e.isLegendToShow.bind(e))), e.legend.selectAll(e.selectorLegends(t)).filter(function() {
        ...
        var e = this.internal,
            i = e.config;
        t.xs && e.addXs(t.xs), "names" in t && v.data.names.bind(this)(t.names), "classes" in t && Object.keys(t.classes).forEach(function(e) {
    ...
    }, v.regions = function(t) {
        var e = this.internal,
            i = e.config;
        return t ? (i.regions = t, e.redrawWithoutRescale(), i.regions) : i.regions
    }, v.regions.add = function(t) {
        var e = this.internal,
            i = e.config;
        return t ? (i.regions = i.regions.concat(t), e.redrawWithoutRescale(), i.regions) : i.regions
    }, v.regions.remove = function(t) {
        var e, i, n, a = this.internal,
            r = a.config;
        return t = t || {}, e = a.getOption(t, "duration", r.transition_duration), i = a.getOption(t, "classes", [o.region]), n = a.main.select("." + o.regions).selectAll(i.map(function(t) {
            return "." + t
        ...
        r.data_selection_enabled && n.main.selectAll("." + o.shapes).selectAll("." + o.shape).each(function(s, c) {
            var d = a.select(this),
                ...
                h = r.data_selection_grouped || !t || t.indexOf(l) >= 0,
                g = !e || e.indexOf(c) >= 0,
                p = d.classed(o.SELECTED);
            d.classed(o.line) || d.classed(o.area) || (h && g ? r.data_selection_isselectable(s) && !p && u(!0, d.classed(o.SELECTED, !0), s, c) : void 0 !== i && i && p && u(!1, d.classed(o.SELECTED, !1), s, c))
        })
    }, v.unselect = function(t, e) {
        var i = this.internal,
            n = i.d3,
            a = i.config;
        a.data_selection_enabled && i.main.selectAll("." + o.shapes).selectAll("." + o.shape).each(function(r, s) {
            var c = n.select(this),
                d = r.data ? r.data.id : r.id,
                l = i.getToggle(this, r).bind(i),
                u = a.data_selection_grouped || !t || t.indexOf(d) >= 0,
                h = !e || e.indexOf(s) >= 0,
                g = c.classed(o.SELECTED);
    ...
    }, b.getSvgArcExpanded = function(t) {
        var e = this,
    ...
    }, b.getArc = function(t, e, i) {
        return i || this.isArcType(t.data) ? this.svgArc(t, e) : "M 0 0"
    }, b.transformForArcLabel = function(t) {
        var e, i, n, a, r, o = this,
            s = o.config,
            d = o.updateAngle(t),
            l = "";
        return d && !o.hasType("gauge") && (e = this.svgArc.centroid(d), i = isNaN(e[0]) ? 0 : e[0], n = isNaN(e[1]) ? 0 : e[1], a = Math.sqrt(i * i + n * n), l = "translate(" + i * (r = o.hasType("donut") && s.donut_label_ratio ? c(s.donut_label_ratio) ? s.donut_label_ratio(t, o.radius, a) : s.donut_label_ratio : o.hasType("pie") && s.pie_label_ratio ? c(s.pie_label_ratio) ? s.pie_label_ratio(t, o.radius, a) : s.pie_label_ratio : o.radius && a ? (36 / o.radius > .375 ? 1.175 - 36 / o.radius : .8) * o.radius / a : 0) + "," + n * r + ")"), l
    }, b.getArcRatio = function(t) {
        var e = this,
            i = e.config,
            n = Math.PI * (e.hasType("gauge") && !i.gauge_fullCircle ? 1 : 2);
        return t ? (t.endAngle - t.startAngle) / n : null
    }, b.convertToArcData = function(t) {
        return this.addName({
            id: t.data.id,
            value: t.value,
    ...
    }, b.textForGaugeMinMax = function(t, e) {
        var i = this.getGaugeLabelExtents();
        return i ? i(t, e) : t
    }, b.expandArc = function(t) {
        var e, i = this;
        ...
        }).attr("d", e.svgArc), e.svg.selectAll("." + o.arc).style("opacity", 1))
    }, b.expandDuration = function(t) {
        var e = this,
            i = e.config;
    ...
    }, b.meetsArcLabelThreshold = function(t) {
        var e = this,
            i = e.config;
    ...
    }, b.updateTargetsForArc = function(t) {
        var e, i = this,
            n = i.main,
        ...
        var t = this;
        t.arcs = t.main.select("." + o.chart).append("g").attr("class", o.chartArcs).attr("transform", t.getTranslate("arc")), t.arcs.append("text").attr("class", o.chartArcsTitle).style("text-anchor", "middle").text(t.getArcTitle())
    }, b.redrawArc = function(t, e, i) {
        var n, a = this,
            r = a.d3,
            s = a.config,
            c = a.main;
        ...
        }), c.select("." + o.chartArcsTitle).style("opacity", a.hasType("donut") || a.hasType("gauge") ? 1 : 0), a.hasType("gauge") && (a.arcs.select("." + o.chartArcsBackground).attr("d", function() {
            var t = {
                data: [{
                    value: s.gauge_max
                }],
        ...
        var t = this,
            ...
            i = t.d3,
            n = e.data_colors,
            a = x(e.color_pattern) ? e.color_pattern : i.scale.category10().range(),
            r = e.data_color,
            o = [];
        return function(t) {
    ...
    }, b.additionalConfig = {}, b.loadConfig = function(t) {
        function e() {
            var t = n.shift();
    ...
    }, b.convertUrlToData = function(t, e, i, n, a) {
        var r = this,
            o = e || "csv",
            s = r.d3.xhr(t);
    ...
    }, b.findValueInJson = function(t, e) {
        ...
        return t
    }, b.convertRowsToData = function(t) {
        var e, i, n = t[0],
            a = {},
            r = [];
        for (e = 1; e < t.length; e++) {
            for (a = {}, i = 0; i < t[e].length; i++) {
                if (void 0 === t[e][i]) throw new Error("Source data is missing a component at (" + e + "," + i + ")!");
                a[n[i]] = t[e][i]
            }
            r.push(a)
        }
        return r
    }, b.convertColumnsToData = function(t) {
        var e, i, n, a = [];
        for (e = 0; e < t.length; e++)
            for (n = t[e][0], i = 1; i < t[e].length; i++) {
                if (void 0 === a[i - 1] && (a[i - 1] = {}), void 0 === t[e][i]) throw new Error("Source data is missing a component at (" + e + "," + i + ")!");
                a[i - 1][n] = t[e][i]
            }
        return a
    }, b.convertDataToTargets = function(t, e) {
        var i, n = this,
            a = n.config,
        ...
        return r.forEach(function(i) {
            ...
            })) : a.data_x ? n.data.xs[i] = n.getOtherTargetXs() : x(a.data_xs) && (n.data.xs[i] = n.getXValuesOfXKey(r, n.data.targets)) : n.data.xs[i] = t.map(function(t, e) {
                return e
            })
    ...
    }, b.addName = function(t) {
        var e, i = this;
        return t && (e = i.config.data_names[t.id], t.name = void 0 !== e ? e : t.id), t
    }, b.getValueOnIndex = function(t, e) {
        var i = t.filter(function(t) {
            return t.index === e
        });
        return i.length ? i[0] : null
    }, b.updateTargetX = function(t, e) {
        var i = this;
        t.forEach(function(t) {
    ...
    }, b.getPrevX = function(t) {
        var e = this.xs[t - 1];
        return void 0 !== e ? e : null
    }, b.getNextX = function(t) {
        var e = this.xs[t + 1];
        return void 0 !== e ? e : null
    ...
    }, b.mapToIds = function(t) {
        return t.map(function(t) {
            return t.id
        })
    }, b.mapToTargetIds = function(t) {
        var e = this;
        return t ? [].concat(t) : e.mapToIds(e.data.targets)
    }, b.hasTarget = function(t, e) {
        var i, n = this.mapToIds(t);
        for (i = 0; i < n.length; i++)
            if (n[i] === e) return !0;
        return !1
    }, b.isTargetToShow = function(t) {
        return this.hiddenTargetIds.indexOf(t) < 0
    }, b.isLegendToShow = function(t) {
        return this.hiddenLegendIds.indexOf(t) < 0
    }, b.filterTargetsToShow = function(t) {
        var e = this;
        return t.filter(function(t) {
            return e.isTargetToShow(t.id)
        })
    }, b.mapTargetsToUniqueXs = function(t) {
        var e = this,
    ...
    }, b.addHiddenTargetIds = function(t) {
        ...
        return n || a ? t.sort(function(t, e) {
            ...
            return n ? r - a : a - r
        }) : c(i.data_order) ? t.sort(i.data_order) : d(i.data_order) && t.sort(function(t, e) {
            return i.data_order.indexOf(t.id) - i.data_order.indexOf(e.id)
        }), t
    }, b.filterByX = function(t, e) {
        return this.d3.merge(t.map(function(t) {
            return t.values
        })).filter(function(t) {
            return t.x - e == 0
        })
    }, b.filterRemoveNull = function(t) {
        return t.filter(function(t) {
            return s(t.value)
        })
    }, b.filterByXDomain = function(t, e) {
        return t.map(function(t) {
            return {
                id: t.id,
                id_org: t.id_org,
    ...
    }, b.getDataLabelLength = function(t, e, i) {
        var n = this,
            a = [0, 0];
    ...
    }, b.convertValuesToStep = function(t) {
        var e, i = [].concat(t);
    ...
    }, b.updateDataAttributes = function(t, e) {
        var i = this,
            n = i.config["data_" + t];
        ...
        e || (e = function() {}), (t = t.filter(function(t) {
            ...
            i.withoutFadeIn[t] = !1, i.legend && i.legend.selectAll("." + o.legendItem + i.getTargetSelectorSuffix(t)).remove(), i.data.targets = i.data.targets.filter(function(e) {
                return e.id !== t
            })
        })) : e()
    }, b.getYDomainMin = function(t) {
    ...
    }, b.getYDomain = function(t, e, i) {
        var n, a, r, o, c, d, l, u, h, g, p = this,
            _ = p.config,
    ...
    }, b.getXDomainPadding = function(t) {
        var e, i, n, a, r = this,
            o = r.config,
            c = t[1] - t[0];
        return i = r.isCategorized() ? 0 : r.hasType("bar") ? (e = r.getMaxDataCount()) > 1 ? c / (e - 1) / 2 : .5 : .01 * c, "object" == typeof o.axis_x_padding && x(o.axis_x_padding) ? (n = s(o.axis_x_padding.left) ? o.axis_x_padding.left : i, a = s(o.axis_x_padding.right) ? o.axis_x_padding.right : i) : n = a = "number" == typeof o.axis_x_padding ? o.axis_x_padding : i, {
            left: n,
            right: a
        }
    }, b.getXDomain = function(t) {
        var e = this,
    ...
    }, b.updateXDomain = function(t, e, i, n, a) {
        var r = this,
            o = r.config;
    ...
    }, b.trimXDomain = function(t) {
        var e = this.getZoomDomain(),
            i = e[0],
            n = e[1];
        return t[0] <= i && (t[1] = +t[1] + (i - t[0]), t[0] = i), n <= t[1] && (t[0] = +t[0] - (t[1] - n), t[1] = n), t
    }, b.drag = function(t) {
        var e, i, n, a, r, s, c, d, l = this,
            u = l.config,
            h = l.main,
            g = l.d3;
        l.hasArcType() || u.data_selection_enabled && (u.zoom_enabled && !l.zoom.altDomain || u.data_selection_multiple && (e = l.dragStart[0], i = l.dragStart[1], n = t[0], a = t[1], r = Math.min(e, n), s = Math.max(e, n), c = u.data_selection_grouped ? l.margin.top : Math.min(i, a), d = u.data_selection_grouped ? l.height : Math.max(i, a), h.select("." + o.dragarea).attr("x", r).attr("y", c).attr("width", s - r).attr("height", d - c), h.selectAll("." + o.shapes).selectAll("." + o.shape).filter(function(t) {
            return u.data_selection_isselectable(t)
        }).each(function(t, e) {
            var i, n, a, u, h, p, f = g.select(this),
                _ = f.classed(o.SELECTED),
                x = f.classed(o.INCLUDED),
                y = !1;
            if (f.classed(o.circle)) i = 1 * f.attr("cx"), n = 1 * f.attr("cy"), h = l.togglePoint, y = r < i && i < s && c < n && n < d;
            else {
                if (!f.classed(o.bar)) return;
                i = (p = w(this)).x, n = p.y, a = p.width, u = p.height, h = l.togglePath, y = !(s < i || i + a < r || d < n || n + u < c)
            }
            y ^ x && (f.classed(o.INCLUDED, !x), f.classed(o.SELECTED, !_), h.call(l, !_, f, t, e))
        })))
    }, b.dragstart = function(t) {
        var e = this,
            i = e.config;
        e.hasArcType() || i.data_selection_enabled && (e.dragStart = t, e.main.select("." + o.chart).append("rect").attr("class", o.dragarea).style("opacity", .1), e.dragging = !0)
    }, b.dragend = function() {
        var t = this,
            e = t.config;
        t.hasArcType() || e.data_selection_enabled && (t.main.select("." + o.dragarea).transition().duration(100).style("opacity", 0).remove(), t.main.selectAll("." + o.shape).classed(o.INCLUDED, !1), t.dragging = !1)
    }, b.getYFormat = function(t) {
        var e = this,
    ...
    }, b.yFormat = function(t) {
        var e = this,
            i = e.config;
        return (i.axis_y_tick_format ? i.axis_y_tick_format : e.defaultValueFormat)(t)
    }, b.y2Format = function(t) {
        var e = this,
            i = e.config;
        return (i.axis_y2_tick_format ? i.axis_y2_tick_format : e.defaultValueFormat)(t)
    }, b.defaultValueFormat = function(t) {
        return s(t) ? +t : ""
    }, b.defaultArcValueFormat = function(t, e) {
        return (100 * e).toFixed(1) + "%"
    }, b.dataLabelFormat = function(t) {
        var e = this.config.data_labels,
            i = function(t) {
                return s(t) ? +t : ""
            };
        return "function" == typeof e.format ? e.format : "object" == typeof e.format ? e.format[t] ? !0 === e.format[t] ? i : e.format[t] : function() {
            return ""
        } : i
    }, b.initGrid = function() {
        var t = this,
            e = t.config,
            i = t.d3;
        t.grid = t.main.append("g").attr("clip-path", t.clipPathForGrid).attr("class", o.grid), e.grid_x_show && t.grid.append("g").attr("class", o.xgrids), e.grid_y_show && t.grid.append("g").attr("class", o.ygrids), e.grid_focus_show && t.grid.append("g").attr("class", o.xgridFocus).append("line").attr("class", o.xgridFocus), t.xgrid = i.selectAll([]), e.grid_lines_front || t.initGridLines()
    }, b.initGridLines = function() {
        var t = this,
            e = t.d3;
        t.gridLines = t.main.append("g").attr("clip-path", t.clipPathForGrid).attr("class", o.grid + " " + o.gridLines), t.gridLines.append("g").attr("class", o.xgridLines), t.gridLines.append("g").attr("class", o.ygridLines), t.xgridLines = e.selectAll([])
    }, b.updateXGrid = function(t) {
        var e = this,
            i = e.config,
            n = e.d3,
        ...
        e.xgridAttr = i.axis_rotated ? {
            ...
            y1: 0,
            y2: e.height
        }, e.xgrid = e.main.select("." + o.xgrids).selectAll("." + o.xgrid).data(a), e.xgrid.enter().append("line").attr("class", o.xgrid), t || e.xgrid.attr(e.xgridAttr).style("opacity", function() {
        ...
        t.ygrid = t.main.select("." + o.ygrids).selectAll("." + o.ygrid).data(i), t.ygrid.enter().append("line").attr("class", o.ygrid), t.ygrid.attr("x1", e.axis_rotated ? t.y : 0).attr("x2", e.axis_rotated ? t.y : t.width).attr("y1", e.axis_rotated ? 0 : t.y).attr("y2", e.axis_rotated ? t.height : t.y), t.ygrid.exit().remove(), t.smoothLines(t.ygrid, "grid")
    }, b.gridTextAnchor = function(t) {
        return t.position ? t.position : "end"
    }, b.gridTextDx = function(t) {
        return "start" === t.position ? 4 : "middle" === t.position ? 0 : -4
    }, b.xGridTextX = function(t) {
        return "start" === t.position ? -this.height : "middle" === t.position ? -this.height / 2 : 0
    }, b.yGridTextX = function(t) {
        return "start" === t.position ? 0 : "middle" === t.position ? this.width / 2 : this.width
    }, b.updateGrid = function(t) {
        var e, i, n, a = this,
            r = a.main,
            s = a.config;
        a.grid.style("visibility", a.hasArcType() ? "hidden" : "visible"), r.select("line." + o.xgridFocus).style("visibility", "hidden"), s.grid_x_show && a.updateXGrid(), a.xgridLines = r.select("." + o.xgridLines).selectAll("." + o.xgridLine).data(s.grid_x_lines), (e = a.xgridLines.enter().append("g").attr("class", function(t) {
            return o.xgridLine + (t.class ? " " + t.class : "")
        })).append("line").style("opacity", 0), e.append("text").attr("text-anchor", a.gridTextAnchor).attr("transform", s.axis_rotated ? "" : "rotate(-90)").attr("dx", a.gridTextDx).attr("dy", -5).style("opacity", 0), a.xgridLines.exit().transition().duration(t).style("opacity", 0).remove(), s.grid_y_show && a.updateYGrid(), a.ygridLines = r.select("." + o.ygridLines).selectAll("." + o.ygridLine).data(s.grid_y_lines), (i = a.ygridLines.enter().append("g").attr("class", function(t) {
    ...
    }, b.showXGridFocus = function(t) {
        var e = this,
            i = e.config,
            n = t.filter(function(t) {
                return t && s(t.value)
            }),
            a = e.main.selectAll("line." + o.xgridFocus),
            r = e.xx.bind(e);
    ...
    }, b.generateGridData = function(t, e) {
        var i, n, a, r, s = this,
            c = [],
            d = s.main.select("." + o.axisX).selectAll(".tick").size();
        if ("year" === t)
            for (n = (i = s.getXDomain())[0].getFullYear(), a = i[1].getFullYear(), r = n; r <= a; r++) c.push(new Date(r + "-01-01 00:00:00"));
        else(c = e.ticks(10)).length > d && (c = c.filter(function(t) {
            return ("" + t).indexOf(".") < 0
        }));
        return c
    }, b.getGridFilterToRemove = function(t) {
        return t ? function(e) {
            var i = !1;
    ...
    }, b.removeGridLines = function(t, e) {
        var i = this,
            n = i.config,
            ...
            s = e ? o.xgridLines : o.ygridLines,
            c = e ? o.xgridLine : o.ygridLine;
        i.main.select("." + s).selectAll("." + c).filter(a).transition().duration(n.transition_duration).style("opacity", 0).remove(), e ? n.grid_x_lines = n.grid_x_lines.filter(r) : n.grid_y_lines = n.grid_y_lines.filter(r)
        ...
        var t, e, i = this,
            n = i.config,
            a = i.isMultipleX(),
            r = i.main.select("." + o.eventRects).style("cursor", n.zoom_enabled ? n.axis_rotated ? "ns-resize" : "ew-resize" : null).classed(o.eventRectsMultiple, a).classed(o.eventRectsSingle, !a);
        r.selectAll("." + o.eventRect).remove(), i.eventRect = r.selectAll("." + o.eventRect), a ? (t = i.eventRect.data([0]), i.generateEventRectsForMultipleXs(t.enter()), i.updateEventRect(t)) : (e = i.getMaxDataCountTarget(i.data.targets), r.datum(e ? e.values : []), i.eventRect = r.selectAll("." + o.eventRect), t = i.eventRect.data(function(t) {
            return t
        }), i.generateEventRectsForSingleX(t.enter()), i.updateEventRect(t), t.exit().remove())
    }, b.updateEventRect = function(t) {
        var e, i, n, a, r, o, s = this,
            c = s.config;
    ...
    }, b.generateEventRectsForSingleX = function(t) {
        var e = this,
            i = e.d3,
            n = e.config;
        t.append("rect").attr("class", e.classEvent.bind(e)).style("cursor", n.data_selection_enabled && n.data_selection_grouped ? "pointer" : null).on("mouseover", function(t) {
            var i = t.index;
            e.dragging || e.flowing || e.hasArcType() || (n.point_focus_expand_enabled && e.expandCircles(i, null, !0), e.expandBars(i, null, !0), e.main.selectAll("." + o.shape + "-" + i).each(function(t) {
                n.data_onmouseover.call(e.api, t)
            }))
        }).on("mouseout", function(t) {
            var i = t.index;
            e.config && (e.hasArcType() || (e.hideXGridFocus(), e.hideTooltip(), e.unexpandCircles(), e.unexpandBars(), e.main.selectAll("." + o.shape + "-" + i).each(function(t) {
                n.data_onmouseout.call(e.api, t)
            })))
        }).on("mousemove", function(t) {
            var a, r = t.index,
                s = e.svg.select("." + o.eventRect + "-" + r);
            e.dragging || e.flowing || e.hasArcType() || (e.isStepType(t) && "step-after" === e.config.line_step_type && i.mouse(this)[0] < e.x(e.getXValue(t.id, r)) && (r -= 1), a = e.filterTargetsToShow(e.data.targets).map(function(t) {
                ...
                i.select(this).classed(o.EXPANDED, !0), n.data_selection_enabled && s.style("cursor", n.data_selection_grouped ? "pointer" : null), n.tooltip_grouped || (e.hideXGridFocus(), e.hideTooltip(), n.data_selection_grouped || (e.unexpandCircles(r), e.unexpandBars(r)))
            }).filter(function(t) {
                return e.isWithinShape(this, t)
            }).each(function(t) {
                n.data_selection_enabled && (n.data_selection_grouped || n.data_selection_isselectable(t)) && s.style("cursor", "pointer"), n.tooltip_grouped || (e.showTooltip([t], this), e.showXGridFocus([t]), n.point_focus_expand_enabled && e.expandCircles(r, t.id, !0), e.expandBars(r, t.id, !0))
            }))
        }).on("click", function(t) {
            var a = t.index;
            !e.hasArcType() && e.toggleShape && (e.cancelClick ? e.cancelClick = !1 : (e.isStepType(t) && "step-after" === n.line_step_type && i.mouse(this)[0] < e.x(e.getXValue(t.id, a)) && (a -= 1), e.main.selectAll("." + o.shape + "-" + a).each(function(t) {
    ...
    }, b.generateEventRectsForMultipleXs = function(t) {
        function e() {
            i.svg.select("." + o.eventRect).style("cursor", null), i.hideXGridFocus(), i.hideTooltip(), i.unexpandCircles(), i.unexpandBars()
        }
        var i = this,
            n = i.d3,
            a = i.config;
        t.append("rect").attr("x", 0).attr("y", 0).attr("width", i.width).attr("height", i.height).attr("class", o.eventRect).on("mouseout", function() {
            ...
            i.dragging || i.hasArcType(c) || (t = n.mouse(this), r = i.findClosestFromTargets(c, t), !i.mouseover || r && r.id === i.mouseover.id || (a.data_onmouseout.call(i.api, i.mouseover), i.mouseover = void 0), r ? (s = (i.isScatterType(r) || !a.tooltip_grouped ? [r] : i.filterByX(c, r.x)).map(function(t) {
                return i.addName(t)
            }), i.showTooltip(s, this), a.point_focus_expand_enabled && i.expandCircles(r.index, r.id, !0), i.expandBars(r.index, r.id, !0), i.showXGridFocus(s), (i.isBarType(r.id) || i.dist(r, t) < a.point_sensitivity) && (i.svg.select("." + o.eventRect).style("cursor", "pointer"), i.mouseover || (a.data_onmouseover.call(i.api, r), i.mouseover = r))) : e())
        }).on("click", function() {
    ...
    }, b.dispatchEvent = function(t, e, i) {
        var n = this,
            a = "." + o.eventRect + (n.isMultipleX() ? "" : "-" + e),
            r = n.main.select(a).node(),
    ...
    }, b.updateSizeForLegend = function(t, e) {
        var i = this,
            n = i.config,
            a = {
    ...
    }, b.transformLegend = function(t) {
        var e = this;
        (t ? e.legend.transition() : e.legend).attr("transform", e.getTranslate("legend"))
    }, b.updateLegendStep = function(t) {
        this.legendStep = t
    }, b.updateLegendItemWidth = function(t) {
        this.legendItemWidth = t
    }, b.updateLegendItemHeight = function(t) {
    ...
    }, b.opacityForLegend = function(t) {
        return t.classed(o.legendItemHidden) ? null : 1
    }, b.opacityForUnfocusedLegend = function(t) {
        return t.classed(o.legendItemHidden) ? null : .3
    }, b.toggleFocusLegend = function(t, e) {
        var i = this;
    ...
    }, b.updateLegend = function(t, e, i) {
        function n(t, e) {
            return b.legendItemTextBox[e] || (b.legendItemTextBox[e] = b.getTextRect(t.textContent, o.legendItem, t)), b.legendItemTextBox[e]
        }

        function a(e, i, a) {
            function r(t, e) {
                e || (o = (p - E - g) / 2) < V && (o = (p - g) / 2, E = 0, X++), F[t] = X, D[X] = b.isLegendInset ? 10 : o, I[t] = E, E += g
            }
            var o, s, c = 0 === a,
                d = a === t.length - 1,
                l = n(e, i),
                u = l.width + G + (!d || b.isLegendRight || b.isLegendInset ? P : 0) + A.legend_padding,
                h = l.height + T,
                g = b.isLegendRight || b.isLegendInset ? h : u,
                p = b.isLegendRight || b.isLegendInset ? b.getLegendHeight() : b.getLegendWidth();
            c && (E = 0, X = 0, L = 0, C = 0), !A.legend_show || b.isLegendToShow(i) ? (O[i] = u, R[i] = h, (!L || u >= L) && (L = u), (!C || h >= C) && (C = h), s = b.isLegendRight || b.isLegendInset ? C : L, A.legend_equally ? (Object.keys(O).forEach(function(t) {
                O[t] = L
            }), Object.keys(R).forEach(function(t) {
                R[t] = C
            }), (o = (p - s * t.length) / 2) < V ? (E = 0, X = 0, t.forEach(function(t) {
                r(t)
            })) : r(i, !0)) : r(i)) : O[i] = R[i] = F[i] = I[i] = 0
        }
        var r, s, c, d, l, u, h, g, p, f, _, x, m, S, w, v, b = this,
            A = b.config,
            T = 4,
            P = 10,
            L = 0,
        ...
        t = t.filter(function(t) {
            return !(void 0 !== A.data_names[t]) || null !== A.data_names[t]
        }), _ = y(e = e || {}, "withTransition", !0), x = y(e, "withTransitionForTransform", !0), b.isLegendInset && (X = A.legend_inset_step ? A.legend_inset_step : t.length, b.updateLegendStep(X)), b.isLegendRight ? (r = function(t) {
            return L * F[t]
        }, d = function(t) {
            return D[F[t]] + I[t]
        }) : b.isLegendInset ? (r = function(t) {
            return L * F[t] + 10
        }, d = function(t) {
            return D[F[t]] + I[t]
        }) : (r = function(t) {
            ...
            return d(t, e) + 4
        }, (f = b.legend.selectAll("." + o.legendItem).data(t).enter().append("g").attr("class", function(t) {
            return b.generateClass(o.legendItem, t)
        }).style("visibility", function(t) {
            return b.isLegendToShow(t) ? "visible" : "hidden"
        }).style("cursor", "pointer").on("click", function(t) {
            A.legend_item_onclick ? A.legend_item_onclick.call(b, t) : b.d3.event.altKey ? (b.api.hide(), b.api.show(t)) : (b.api.toggle(t), b.isTargetToShow(t) ? b.api.focus(t) : b.api.revert())
        }).on("mouseover", function(t) {
            A.legend_item_onmouseover ? A.legend_item_onmouseover.call(b, t) : (b.d3.select(this).classed(o.legendItemFocused, !0), !b.transiting && b.isTargetToShow(t) && b.api.focus(t))
        }).on("mouseout", function(t) {
            A.legend_item_onmouseout ? A.legend_item_onmouseout.call(b, t) : (b.d3.select(this).classed(o.legendItemFocused, !1), b.api.revert())
        })).append("text").text(function(t) {
            return void 0 !== A.data_names[t] ? A.data_names[t] : t
        }).each(function(t, e) {
            a(this, t, e)
        }).style("pointer-events", "none").attr("x", b.isLegendRight || b.isLegendInset ? s : -200).attr("y", b.isLegendRight || b.isLegendInset ? -200 : l), f.append("rect").attr("class", o.legendItemEvent).style("fill-opacity", 0).attr("x", b.isLegendRight || b.isLegendInset ? c : -200).attr("y", b.isLegendRight || b.isLegendInset ? -200 : u), f.append("line").attr("class", o.legendItemTile).style("stroke", b.color).style("pointer-events", "none").attr("x1", b.isLegendRight || b.isLegendInset ? h : -200).attr("y1", b.isLegendRight || b.isLegendInset ? -200 : p).attr("x2", b.isLegendRight || b.isLegendInset ? g : -200).attr("y2", b.isLegendRight || b.isLegendInset ? -200 : p).attr("stroke-width", A.legend_item_tile_height), v = b.legend.select("." + o.legendBackground + " rect"), b.isLegendInset && L > 0 && 0 === v.size() && (v = b.legend.insert("g", "." + o.legendItem).attr("class", o.legendBackground).append("rect")), m = b.legend.selectAll("text").data(t).text(function(t) {
            return void 0 !== A.data_names[t] ? A.data_names[t] : t
        }).each(function(t, e) {
            a(this, t, e)
        }), (_ ? m.transition() : m).attr("x", s).attr("y", l), S = b.legend.selectAll("rect." + o.legendItemEvent).data(t), (_ ? S.transition() : S).attr("width", function(t) {
            return O[t]
        }).attr("height", function(t) {
            return R[t]
        }).attr("x", c).attr("y", u), w = b.legend.selectAll("line." + o.legendItemTile).data(t), (_ ? w.transition() : w).style("stroke", b.color).attr("x1", h).attr("y1", p).attr("x2", g).attr("y2", p), v && (_ ? v.transition() : v).attr("height", b.getLegendHeight() - 12).attr("width", L * (X + 1) + 10), b.legend.selectAll("." + o.legendItem).classed(o.legendItemHidden, function(t) {
            return !b.isTargetToShow(t)
        }), b.updateLegendItemWidth(L), b.updateLegendItemHeight(C), b.updateLegendStep(X), b.updateSizes(), b.updateScales(), b.updateSvgSize(), b.transformAll(x, i), b.legendHasRendered = !0
    }, b.initRegion = function() {
        var t = this;
        t.region = t.main.append("g").attr("clip-path", t.clipPath).attr("class", o.regions)
    }, b.updateRegion = function(t) {
        var e = this,
            i = e.config;
        e.region.style("visibility", e.hasArcType() ? "hidden" : "visible"), e.mainRegion = e.main.select("." + o.regions).selectAll("." + o.region).data(i.regions), e.mainRegion.enter().append("g").append("rect").style("fill-opacity", 0), e.mainRegion.attr("class", e.classRegion.bind(e)), e.mainRegion.exit().transition().duration(t).style("opacity", 0).remove()
    }, b.redrawRegion = function(t) {
        var e = this,
    ...
    }, b.unselectPoint = function(t, e, i) {
        var n = this;
    ...
    }, b.togglePoint = function(t, e, i, n) {
        t ? this.selectPoint(e, i, n) : this.unselectPoint(e, i, n)
    }, b.selectPath = function(t, e) {
        var i = this;
    ...
    }, b.updateTargetsForBar = function(t) {
        var e = this,
            i = e.config,
        ...
        e.mainBar = e.main.selectAll("." + o.bars).selectAll("." + o.bar).data(i), e.mainBar.enter().append("path").attr("class", n).style("stroke", r).style("fill", r), e.mainBar.style("opacity", a), e.mainBar.exit().transition().duration(t).style("opacity", 0).remove()
    }, b.redrawBar = function(t, e) {
        return [(e ? this.mainBar.transition(Math.random().toString()) : this.mainBar).attr("d", t).style("fill", this.color).style("opacity", 1)]
    }, b.getBarW = function(t, e) {
        var i = this.config,
    ...
    }, b.getBars = function(t, e) {
        var i = this;
        return (e ? i.main.selectAll("." + o.bars + i.getTargetSelectorSuffix(e)) : i.main).selectAll("." + o.bar + (s(t) ? "-" + t : ""))
    }, b.expandBars = function(t, e, i) {
        var n = this;
        i && n.unexpandBars(), n.getBars(t, e).classed(o.EXPANDED, !0)
    }, b.unexpandBars = function(t) {
        this.getBars(t).classed(o.EXPANDED, !1)
    }, b.generateDrawBar = function(t, e) {
        var i = this,
            n = i.config,
    ...
    }, b.generateGetBarPoints = function(t, e) {
        var i = this,
        ...
        return function(t, e) {
            var n = d.call(i, t.id)(0),
                a = c(t, e) || n,
                l = o(t),
                u = s(t);
            return i.config.axis_rotated && (0 < t.value && u < n || t.value < 0 && n < u) && (u = n), [
                [l, a],
                [l, u - (n - a)],
                [l + r, u - (n - a)],
                [l + r, a]
    ...
    }, b.getShapeY = function(t) {
        var e = this;
        return function(i) {
            return (t ? e.getSubYScale(i.id) : e.getYScale(i.id))(i.value)
        }
    }, b.getShapeOffset = function(t, e, i) {
        var n = this,
    ...
    }, b.isWithinShape = function(t, e) {
        var i, n = this,
            a = n.d3.select(t);
        return n.isTargetToShow(e.id) ? "circle" === t.nodeName ? i = n.isStepType(e) ? n.isWithinStep(t, n.getYScale(e.id)(e.value)) : n.isWithinCircle(t, 1.5 * n.pointSelectR(e)) : "path" === t.nodeName && (i = !a.classed(o.bar) || n.isWithinBar(t)) : i = !1, i
    }, b.getInterpolate = function(t) {
        var e = this,
    ...
    }, b.updateTargetsForLine = function(t) {
        var e, i = this,
            n = i.config,
    ...
    }, b.updateLine = function(t) {
        var e = this;
        e.mainLine = e.main.selectAll("." + o.lines).selectAll("." + o.line).data(e.lineData.bind(e)), e.mainLine.enter().append("path").attr("class", e.classLine.bind(e)).style("stroke", e.color), e.mainLine.style("opacity", e.initialOpacity.bind(e)).style("shape-rendering", function(t) {
            return e.isStepType(t) ? "crispEdges" : ""
        }).attr("transform", null), e.mainLine.exit().transition().duration(t).style("opacity", 0).remove()
    }, b.redrawLine = function(t, e) {
        return [(e ? this.mainLine.transition(Math.random().toString()) : this.mainLine).attr("d", t).style("stroke", this.color).style("opacity", 1)]
    }, b.generateDrawLine = function(t, e) {
        var i = this,
            n = i.config,
            a = i.d3.svg.line(),
    ...
    }, b.generateGetLinePoints = function(t, e) {
        var i = this,
            n = i.config,
            a = t.__max__ + 1,
    ...
    }, b.lineWithRegions = function(t, e, i, n) {
        function a(t) {
            return "M" + t[0][0] + " " + t[0][1] + " " + t[1][0] + " " + t[1][1]
        }
        var r, o, s, c, d, l, u, h, g, p, f, _ = this,
            x = _.config,
            y = "M",
            m = _.isCategorized() ? .5 : 0,
            S = [];
        if (void 0 !== n)
        ...
        for (p = x.axis_rotated ? function(t) {
                return i(t.value)
            } : function(t) {
                return e(t.x)
            }, f = x.axis_rotated ? function(t) {
                return e(t.x)
            } : function(t) {
                return i(t.value)
            ...
            if (void 0 !== S && function(t, e) {
                ...
                for (c = _.getScale(t[r - 1].x + m, t[r].x + m, _.isTimeSeries()), d = _.getScale(t[r - 1].value, t[r].value), l = e(t[r].x) - e(t[r - 1].x), u = i(t[r].value) - i(t[r - 1].value), g = 2 * (h = 2 / Math.sqrt(Math.pow(l, 2) + Math.pow(u, 2))), o = h; o <= 1; o += g) y += s(t[r - 1], t[r], o, h);
            else y += " " + p(t[r]) + " " + f(t[r]);
            t[r].x
        }
        return y
    }, b.updateArea = function(t) {
        var e = this,
            i = e.d3;
        e.mainArea = e.main.selectAll("." + o.areas).selectAll("." + o.area).data(e.lineData.bind(e)), e.mainArea.enter().append("path").attr("class", e.classArea.bind(e)).style("fill", e.color).style("opacity", function() {
    ...
    }, b.generateDrawArea = function(t, e) {
        var i = this,
            n = i.config,
            a = i.d3.svg.area(),
        ...
        return 0
    }, b.generateGetAreaPoints = function(t, e) {
        var i = this,
            n = i.config,
            a = t.__max__ + 1,
            r = i.getShapeX(0, a, t, !!e),
        ...
        var t = this;
        t.mainCircle = t.main.selectAll("." + o.circles).selectAll("." + o.circle).data(t.lineOrScatterData.bind(t)), t.mainCircle.enter().append("circle").attr("class", t.classCircle.bind(t)).attr("r", t.pointR.bind(t)).style("fill", t.color), t.mainCircle.style("opacity", t.initialOpacityForCircle.bind(t)), t.mainCircle.exit().remove()
    }, b.redrawCircle = function(t, e, i) {
    ...
    }, b.getCircles = function(t, e) {
        var i = this;
        return (e ? i.main.selectAll("." + o.circles + i.getTargetSelectorSuffix(e)) : i.main).selectAll("." + o.circle + (s(t) ? "-" + t : ""))
    }, b.expandCircles = function(t, e, i) {
        var n = this,
            a = n.pointExpandedR.bind(n);
        i && n.unexpandCircles(), n.getCircles(t, e).classed(o.EXPANDED, !0).attr("r", a)
    }, b.unexpandCircles = function(t) {
        var e = this,
            i = e.pointR.bind(e);
        ...
        var e = this,
            i = e.config;
        return e.isStepType(t) ? 0 : c(i.point_r) ? i.point_r(t) : i.point_r
    }, b.pointExpandedR = function(t) {
        var e = this,
            i = e.config;
        return i.point_focus_expand_enabled ? i.point_focus_expand_r ? i.point_focus_expand_r : 1.75 * e.pointR(t) : e.pointR(t)
    }, b.pointSelectR = function(t) {
        var e = this,
            i = e.config;
        return c(i.point_select_r) ? i.point_select_r(t) : i.point_select_r ? i.point_select_r : 4 * e.pointR(t)
    }, b.isWithinCircle = function(t, e) {
        var i = this.d3,
            n = i.mouse(t),
            a = i.select(t),
            r = +a.attr("cx"),
        ...
        var t = this,
            e = t.config,
            i = s(e.padding_top) ? e.padding_top : 0;
    ...
    }, b.getCurrentPaddingLeft = function(t) {
        var e = this,
            i = e.config;
        return s(i.padding_left) ? i.padding_left : i.axis_rotated ? i.axis_x_show ? Math.max(g(e.getAxisWidthByAxisId("x", t)), 40) : 1 : !i.axis_y_show || i.axis_y_inner ? e.axis.getYAxisLabelPosition().isOuter ? 30 : 1 : g(e.getAxisWidthByAxisId("y", t))
    }, b.getCurrentPaddingRight = function() {
        var t = this,
            e = t.config,
            i = t.isLegendRight ? t.getLegendWidth() + 20 : 0;
        return s(e.padding_right) ? e.padding_right + 1 : e.axis_rotated ? 10 + i : !e.axis_y2_show || e.axis_y2_inner ? 2 + i + (t.axis.getY2AxisLabelPosition().isOuter ? 20 : 0) : g(t.getAxisWidthByAxisId("y2")) + i
    }, b.getParentRectValue = function(t) {
    ...
    }, b.getSvgLeft = function(t) {
        var e = this,
            i = e.config,
            n = i.axis_rotated || !i.axis_rotated && !i.axis_y_inner,
            a = i.axis_rotated ? o.axisX : o.axisY,
        ...
        i.style("visibility", n), i.append("g").attr("clip-path", t.clipPathForSubchart).attr("class", o.chart), i.select("." + o.chart).append("g").attr("class", o.chartBars), i.select("." + o.chart).append("g").attr("class", o.chartLines), i.append("g").attr("clip-path", t.clipPath).attr("class", o.brush).call(t.brush), t.axes.subx = i.append("g").attr("class", o.axisX).attr("transform", t.getTranslate("subx")).attr("clip-path", e.axis_rotated ? "" : t.clipPathForXAxis).style("visibility", e.subchart_axis_x_show ? n : "hidden")
    }, b.updateTargetsForSubchart = function(t) {
        var e, i = this,
            n = i.context,
            a = i.config,
        ...
        a.subchart_show && (n.select("." + o.chartBars).selectAll("." + o.chartBar).data(t).attr("class", r).enter().append("g").style("opacity", 0).attr("class", r).append("g").attr("class", s), (e = n.select("." + o.chartLines).selectAll("." + o.chartLine).data(t).attr("class", c).enter().append("g").style("opacity", 0).attr("class", c)).append("g").attr("class", d), e.append("g").attr("class", l), n.selectAll("." + o.brush + " rect").attr(a.axis_rotated ? "width" : "height", a.axis_rotated ? i.width2 : i.height2))
    }, b.updateBarForSubchart = function(t) {
        var e = this;
        e.contextBar = e.context.selectAll("." + o.bars).selectAll("." + o.bar).data(e.barData.bind(e)), e.contextBar.enter().append("path").attr("class", e.classBar.bind(e)).style("stroke", "none").style("fill", e.color), e.contextBar.style("opacity", e.initialOpacity.bind(e)), e.contextBar.exit().transition().duration(t).style("opacity", 0).remove()
    }, b.redrawBarForSubchart = function(t, e, i) {
        (e ? this.contextBar.transition(Math.random().toString()).duration(i) : this.contextBar).attr("d", t).style("opacity", 1)
    }, b.updateLineForSubchart = function(t) {
        var e = this;
        e.contextLine = e.context.selectAll("." + o.lines).selectAll("." + o.line).data(e.lineData.bind(e)), e.contextLine.enter().append("path").attr("class", e.classLine.bind(e)).style("stroke", e.color), e.contextLine.style("opacity", e.initialOpacity.bind(e)), e.contextLine.exit().transition().duration(t).style("opacity", 0).remove()
    }, b.redrawLineForSubchart = function(t, e, i) {
        (e ? this.contextLine.transition(Math.random().toString()).duration(i) : this.contextLine).attr("d", t).style("opacity", 1)
    }, b.updateAreaForSubchart = function(t) {
        var e = this,
            i = e.d3;
        e.contextArea = e.context.selectAll("." + o.areas).selectAll("." + o.area).data(e.lineData.bind(e)), e.contextArea.enter().append("path").attr("class", e.classArea.bind(e)).style("fill", e.color).style("opacity", function() {
            return e.orgAreaOpacity = +i.select(this).style("opacity"), 0
        }), e.contextArea.style("opacity", 0), e.contextArea.exit().transition().duration(t).style("opacity", 0).remove()
    }, b.redrawAreaForSubchart = function(t, e, i) {
    ...
    }, b.redrawSubchart = function(t, e, i, n, a, r, o) {
        var s, c, d, l = this,
            u = l.d3,
            h = l.config;
    ...
    }, b.transformContext = function(t, e) {
        var i, n = this;
        e && e.axisSubX ? i = e.axisSubX : (i = n.context.select("." + o.axisX), t && (i = i.transition())), n.context.attr("transform", n.getTranslate("context")), i.attr("transform", n.getTranslate("subx"))
    }, b.getDefaultExtent = function() {
        var t = this,
            e = t.config,
            i = c(e.axis_x_extent) ? e.axis_x_extent(t.getXDomain(t.data.targets)) : e.axis_x_extent;
    ...
    }, b.updateTargetsForText = function(t) {
        var e = this,
    ...
    }, b.generateXYForText = function(t, e, i, n) {
        var a = this,
        ...
        var t, e = this,
            i = e.config;
        if (e.tooltip = e.selectChart.style("position", "relative").append("div").attr("class", o.tooltipContainer).style("position", "absolute").style("pointer-events", "none").style("display", "none"), i.tooltip_init_show) {
            if (e.isTimeSeries() && l(i.tooltip_init_x)) {
        ...
        if (l(n) && "asc" === n.toLowerCase()) return function(t, e) {
            return a(t) - a(e)
        };
        if (l(n) && "desc" === n.toLowerCase()) return function(t, e) {
            return a(e) - a(t)
        };
        if (c(n)) {
            var r = n;
    ...
    }, b.getTooltipContent = function(t, e, i, n) {
        ...
        for (f && t.sort(f), r = 0; r < t.length; r++)
            if (t[r] && (t[r].value || 0 === t[r].value) && (a || (o = S(h ? h(t[r].x) : t[r].x), a = "<table class='" + l.CLASS.tooltip + "'>" + (o || 0 === o ? "<tr><th colspan='2'>" + o + "</th></tr>" : "")), void 0 !== (s = S(p(t[r].value, t[r].ratio, t[r].id, t[r].index, t))))) {
                if (null === t[r].name) continue;
                c = S(g(t[r].name, t[r].ratio, t[r].id, t[r].index)), d = l.levelColor ? l.levelColor(t[r].value) : n(t[r].id), a += "<tr class='" + l.CLASS.tooltipName + "-" + l.getTargetSelectorSuffix(t[r].id) + "'>", a += "<td class='name'><span style='background-color:" + d + "'></span>" + c + "</td>", a += "<td class='value'>" + s + "</td>", a += "</tr>"
            }
        return a + "</table>"
    }, b.tooltipPosition = function(t, e, i, n) {
        ...
        var i, n, a, r = this,
            ...
            l = o.tooltip_position || b.tooltipPosition;
        0 !== d.length && o.tooltip_show && (r.tooltip.html(o.tooltip_contents.call(r, t, r.axis.getXAxisTickFormat(), r.getYFormat(c), r.color)).style("display", "block"), i = r.tooltip.property("offsetWidth"), n = r.tooltip.property("offsetHeight"), a = l.call(this, d, i, n, e), r.tooltip.style("top", a.top + "px").style("left", a.left + "px"))
    }, b.hideTooltip = function() {
        this.tooltip.style("display", "none")
    }, b.setTargetType = function(t, e) {
        var i = this,
            n = i.config;
        i.mapToTargetIds(t).forEach(function(t) {
            i.withoutFadeIn[t] = e === n.data_types[t], n.data_types[t] = e
        }), t || (n.data_type = e)
    }, b.hasType = function(t, e) {
        var i = this,
        ...
        e.zoom = i.behavior.zoom().on("zoomstart", function() {
            ...
            var t = f(e.x.orgDomain()) / f(e.getZoomDomain()),
